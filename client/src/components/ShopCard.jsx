const ShopCard = ({ shop }) => {
    return (
        <article className="group relative flex items-center gap-4 rounded-xl border border-white/10 bg-[#13162b] p-3 shadow-md transition-all hover:bg-[#1c2035] hover:border-white/20 cursor-default">
